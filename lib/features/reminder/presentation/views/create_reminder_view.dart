...
class _CreateReminderViewState extends State<CreateReminderView>
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Container(height: 338.h, width: double.infinity, color: Colors.red),
            ...
            const EditTextFieldWidget(title: 'Title'),
  ...
  Widget _buildTimeWidget({required String time}) => Container(
    decoration: BoxDecoration(
      borderRadius: BorderRadius.circular(4.r),
      border: Border.all(color: AppColors.grey200),
    ),
