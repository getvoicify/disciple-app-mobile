...
import 'package:disciple/features/reminder/domain/usecase/update_reminder_usecases.dart';
...
final updateReminderUseCaseImpl = Provider<DiscipleUseCaseWithOptionalParam>(
  (ref) => UpdateReminderUseCaseImpl(service: ref.read(reminderServiceModule)),
);
