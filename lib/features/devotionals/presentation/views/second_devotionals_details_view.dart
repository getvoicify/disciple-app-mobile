          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 16.w),
                ImageWidget(imageUrl: AppImage.bookmark),
                SizedBox(width: 8.w),
                ImageWidget(imageUrl: AppImage.download),
                SizedBox(width: 8.w),
                ImageWidget(imageUrl: AppImage.shareIcon2),
              ],
            ),
          ),

          Divider(color: AppColors.purple, thickness: 2),
          Padding(
            padding: EdgeInsets.symmetric(horizontal: 16.w),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
