...
import '../widget/message_entry_widget.dart';
...
class _CommunityChatsViewState extends State<CommunityChatsView>
  ...
  Widget _buildMemberItem({required String name, bool isAdmin = false}) {
    return Card(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width: 16.w),
            ImageWidget(imageUrl: AppImage.healthIconsCancelOutline),
          ],
        ),
      ),
    );
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(width: 8.w),
              ImageWidget(imageUrl: AppImage.callIcon, fit: BoxFit.none),
            ],
          ),
        ),
        SizedBox(width: 44.w),
      ...
      children: [
        Row(
          children: [
            ...
            ImageWidget(imageUrl: AppImage.penIcon, fit: BoxFit.none),
          ],
        ),
        SizedBox(height: 8.h),
  ...
  Widget _buildInfoItem(String iconPath, String text, Color textColor) {
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: [
