  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Feed'),
        actions: [
          ImageWidget(imageUrl: AppImage.notificationIcon),
          SizedBox(width: 16.w),
          CircleAvatar(),
          SizedBox(width: 16.w),
        ],
                  ...
                  Container(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        spacing: 32.w,
                        children: [
                          ActionButtonWidget(icon: AppImage.likeIcon),
                          ActionButtonWidget(icon: AppImage.shareIcon),
                          ActionButtonWidget(icon: AppImage.expandIcon),
                        ],
                      ),
                    ),
                  ),
